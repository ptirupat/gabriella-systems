...
| this PR (2026-09-21) | Public bowling label **Arm speed** → **Arm angular speed** (°/s). Heroes unchanged: bowling hero is Run-up **20.4** only. GIF binaries not regenerated. |

**2026-09-21 label (Arm angular speed):** public bowling labels that still said **Arm speed** now say **Arm angular speed**. Units stay **°/s** (detail sample **619**). The `data-metric-tip` key stays `arm-speed`. Homepage heroes stay **Bat speed at impact 10.6** + **Head stability 45.9** + **Run-up speed 20.4** only. Arm angular speed remains clip-HUD / session-progress detail. Release height stays off hero rows. GIF binaries were not regenerated.
