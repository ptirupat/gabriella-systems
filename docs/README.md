...
Canonical **product** documentation lives in [Gabriella-Systems/modal](https://github.com/Gabriella-Systems/modal) under [`docs/`](https://github.com/Gabriella-Systems/modal/tree/main/docs):

| File | What it is |
| --- | --- |
| [PRODUCT.md](https://github.com/Gabriella-Systems/modal/blob/main/docs/PRODUCT.md) | Product contract |
| [METRICS_CATALOG.md](https://github.com/Gabriella-Systems/modal/blob/main/docs/METRICS_CATALOG.md) | Metrics catalog |
| [CV_FEATURES.md](https://github.com/Gabriella-Systems/modal/blob/main/docs/CV_FEATURES.md) | CV features |
